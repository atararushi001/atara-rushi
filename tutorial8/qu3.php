...
<body>
    <div class="container-sm d-flex align-items-center justify-content-center" style="margin-top: 1rem; margin-bottom: 1rem;">
        <div class="card p-4" style="width: 33%; min-width: 350px;">
            <h1 class="display-6 text-center text-primary">Prime Numbers</h1>
            <form method="POST" class="d-flex flex-column justify-content-center">
                <div class="mt-3 mb-3 form-floating">
                    ...
                    <label for="n">Enter Limit of N to Print Primes</label>
                </div>
