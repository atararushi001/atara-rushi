...
<body>
    <div class="container-sm d-flex align-items-center justify-content-center" style="margin-top: 10rem;">
        <div class="card p-4" style="width: 33%; min-width: 350px;">
            <h1 class="display-6 mb-4 text-center text-primary">Swap Numbers using Call By Reference</h1>
            ...
            <?php
                ...
                if(isset($_POST['submit'])) {
                    ...
                    swap_ref($first_number, $second_number);

                    echo "<h5 class='mt-3'>Number 1: $first_number, Number 2: $second_number </h4>";
                }
            ?>
        </div>
    </div>
