...
<body>
    <div class="container-sm d-flex align-items-center justify-content-center" style="margin-top: 10rem;">
        <div class="card p-4" style="width: 33%; min-width: 350px;">
            <h1 class="display-6 mb-4 text-center text-primary">Enter Numbers</h1>
            ...
            <?php
                ...
                if(isset($_POST['submit'])) {
                    ...
                    echo "<h5 class='mt-3'>Maximum Number: " . max_of_two($first_number, $second_number) . "</h4>";
                }
            ?>
        </div>
    </div>
