...
<body>
    <div class="container-sm d-flex align-items-center justify-content-center" style="margin-top: 10rem;">
        <div class="card p-4" style="width: 33%; min-width: 350px;">
            <h1 class="display-6 mb-4 text-center text-primary">Enter Numbers to find Maximum </h1>
            <form method="POST" class="d-flex flex-column h-100 justify-content-center">
                ...
                <div class="mb-3 form-floating">
                    <input type="number" name="n3" id="n3" class="form-control" placeholder="Number 3"required>
            ...
            <?php
                ...
                if(isset($_POST['submit'])) {
                    ...
                    echo "<h5 class='mt-3'>Maximum Number: $max</h4>";
                }
            ?>
        </div>
    </div>
